...
export default function Navbar() {
    ...
    return (
        <>
            <div className="fixed top-0 fix-block right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden">
                <img src="./assets/header-bg-color.png" alt="" className="w-full" />
            </div>

            <nav ref={navRef} className="w-full top-div fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">

                <a href="#!">
                    <img src="./assets/new-dp-white.jpg" alt="Logo" className="w-28 cursor-pointer mr-14 dark:hidden" />
                    <img src="./assets/new-add-dp.jpg" alt="Logo" className="w-28 cursor-pointer mr-14 hidden dark:block" />
                </a>
